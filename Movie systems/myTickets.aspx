<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="myTickets.aspx.cs" Inherits="MovieSystem.WebForm7" %>
    ...
    <div>
        <form id="form1" runat="server">
            <div runat="server"  id="isticket" visible="false">
                ...
                <asp:Button runat="server" ID="booktickets" class="btn btn-success" Text="Book TIckets Now!!" OnClick="booktickets_Click"/></center>
            </div>
            ...
            <asp:GridView ID="GridView1" CssClass="table table-success table-striped" AutoGenerateColumns="false" runat="server" OnRowDeleting="GridView1_RowDeleting" DataKeyNames="Ticket_Id" ShowHeader="true">
                <Columns>
            ...
            <center><div id="issuccess" runat="server" visible="false" style="color:red"><h5>Ticket Canceled. Amount Will be Refunded Soon.</h5></div></center>
        </form>
    </div>
</asp:Content>
